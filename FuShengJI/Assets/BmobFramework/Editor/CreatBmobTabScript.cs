...
public class CreateBmobTabScript
{
    [MenuItem("Assets/Create/BmobTabScript", false, 80)]
    public static void CreateBmobTab()
    {
        ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
            ScriptableObject.CreateInstance<CreateScriptAssetAction>(),
            GetSelectedPathOrFallback() + "/BmobTab New.cs",
            null,
            "Assets/BmobFramework/Editor/Template/BmobTabScript.txt");
    }
    ...
    [MenuItem("Assets/Create/ExcelToBmobTab", false, 80)]
    public static void CreateBmobSSS()
    {
...
class CreateScriptAssetAction : EndNameEditAction
{
    ...
    internal static UnityEngine.Object CreateAssetFromTemplate(string pahtName, string resourceFile)
    {
        ...
        content = content.Replace("${TableName}", fileName);
